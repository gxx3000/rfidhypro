package com.rfidhy.common.utils.file;
...
import com.rfidhy.common.exception.file.FileNameLengthLimitExceededException;
import com.rfidhy.common.exception.file.FileSizeLimitExceededException;
import com.rfidhy.common.exception.file.InvalidExtensionException;
...
import com.rfidhy.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = RfidhyConfig.getProfile();
    ...
    {
        int dirLastIndex = RfidhyConfig.getProfile().length() + 1;
